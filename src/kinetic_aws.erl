...
sign_v4(AccessKeyId, SecretAccessKey, Service, Region, Date, Target, Body) ->
    ...
    CanonicalRequest = ["POST", $\n,
                        ...
                        bin_to_hex(crypto:hash(sha256, Body))],
    ...
    StringToSign = ["AWS4-HMAC-SHA256", $\n,
                    ...
                    bin_to_hex(crypto:hash(sha256, CanonicalRequest))],


    % Signing
    Signature = bin_to_hex(crypto:hmac(sha256, SigningKey, StringToSign)),
    {ok,
...
%% Lovingly cribbed from http://stackoverflow.com/a/3771421
